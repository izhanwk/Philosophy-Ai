      ...
      <div className="flex-1 px-4 py-8 sm:px-6 sm:py-12 lg:px-10">
        <section className="mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-[1.2fr_1fr]">
          ...
          <div className="relative mx-auto flex max-w-sm flex-col items-center">
            <div className="relative h-40 w-40 overflow-hidden rounded-full border border-white/15 bg-white/5 shadow-[0_10px_40px_-12px_rgba(0,0,0,0.45)] backdrop-blur sm:h-52 sm:w-52 lg:h-56 lg:w-56">
              <Image
                src="/Alghazali.png"
                alt="Al-Ghazali"
                fill
        ...
        >
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="space-y-5 text-center md:text-left">
              ...
              <p className="mx-auto max-w-2xl text-sm leading-relaxed text-white/70 sm:text-base md:mx-0">
            ...
            <div className="relative mx-auto flex items-center justify-center">
              <div className="relative h-52 w-52 overflow-hidden rounded-2xl border border-white/15 bg-white/5 shadow-[0_15px_50px_-20px_rgba(0,0,0,0.5)] backdrop-blur sm:h-60 sm:w-60 md:h-64 md:w-64">
                <Image
                  src="/Aristotle.png"
                  alt="Aristotle"
                  fill
